/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7d52c36bf1e4ef7e75aa183080da7aa1)
// Runtime types generated with workerd@1.20260811.1 2026-07-06 nodejs_compat
interface __BaseEnv_Env {
  ...
  ARC_API_KEY: string;
  SELF_ORIGIN: string;
  ANTHROPIC_PROXY_AUDIENCE: string;
  GITHUB_TOKEN: string;
