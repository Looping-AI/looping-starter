/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: beb69a31c0cf66a08741c4f69d883374)
// Runtime types generated with workerd@1.20260815.1 2026-07-06 nodejs_compat
interface __BaseEnv_Env {
  ...
  ClaudeCoderAgent: DurableObjectNamespace<
    import("./src/index").ClaudeCoderAgent
  >;
  CODER_WORKSPACE: DurableObjectNamespace<
    import("./src/index").CoderWorkspaceDO
  >;
  CLAUDE_CODER_WORKSPACE: DurableObjectNamespace<
    import("./src/index").ClaudeCoderWorkspaceDO
  >;
  HANDLE_TASK_WORKFLOW: Workflow<
    Parameters<import("./src/index").HandleTaskWorkflow["run"]>[0]["payload"]
  >;
  ARC_HANDLE_TASK_WORKFLOW: Workflow<
    Parameters<import("./src/index").ArcHandleTaskWorkflow["run"]>[0]["payload"]
  >;
  NOTIFY_WORKFLOW: Workflow<
    Parameters<import("./src/index").NotifyTaskWorkflow["run"]>[0]["payload"]
  >;
  CODER_WORKFLOW: Workflow<
    Parameters<import("./src/index").CoderWorkflow["run"]>[0]["payload"]
  >;
  CLAUDE_CODER_WORKFLOW: Workflow<
    Parameters<import("./src/index").ClaudeCoderWorkflow["run"]>[0]["payload"]
  >;
}
